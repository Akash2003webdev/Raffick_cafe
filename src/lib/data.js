...
export const restaurantInfo = {
  ...
  address: "Old Trunk Road, Sattur, Tamil Nadu 626203",
  phone: "09994499155",
  whatsapp: "919994499155",
  rating: 4.3,
  reviewCount: 51,
...
export const categories = [
  { id: "cat-pasta", name: "Pasta", image: "https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=300&q=80", sort_order: 1, status: "active" },
  { id: "cat-burgers", name: "Burgers", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=300&q=80", sort_order: 2, status: "active" },
  { id: "cat-riceandnoodles", name: "Rice & Noodles", image: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=300&q=80", sort_order: 3, status: "active" },
  { id: "cat-sandwiches", name: "Sandwiches", image: "https://images.unsplash.com/photo-1521390188846-e2a3a97453a0?w=300&q=80", sort_order: 4, status: "active" },
  { id: "cat-pizza", name: "Pizza", image: "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=300&q=80", sort_order: 5, status: "active" },
  { id: "cat-beverages", name: "Coffee & Beverages", image: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=300&q=80", sort_order: 6, status: "active" },
  { id: "cat-shakes", name: "Shakes", image: "https://images.unsplash.com/photo-1541658016709-82535e94bc69?w=300&q=80", sort_order: 7, status: "active" },
  { id: "cat-desserts", name: "Desserts", image: "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=300&q=80", sort_order: 8, status: "active" },
];
...
function item({ id, categoryId, categoryName, name, description, vegType, rating, reviewCount, image, variants, status = "active" }) {
  return {
    id,
...
export const menuItems = [
  ...
  item({
    ...
    name: "Chicken Burger",
    description: "Juicy grilled chicken patty, cheese, lettuce & our special sauce.",
    vegType: "non-veg",
    rating: 4.7,
    reviewCount: 203,
  ...
  item({
    ...
    name: "Club Sandwich",
    description: "Triple-layered sandwich with veggies, cheese and a smoky sauce.",
    vegType: "veg",
    rating: 4.5,
    reviewCount: 68,
  ...
  item({
    ...
    description: "Fudgy chocolate brownie served warm with a chocolate drizzle.",
    vegType: "veg",
    rating: 4.8,
    reviewCount: 154,
...
export const overallReviews = [
  { id: "rev-1", name: "Aravind K.", rating: 5, comment: "Cozy place with amazing food. The pasta and coffee combo is unbeatable!", date: "2026-06-12" },
  { id: "rev-2", name: "Priya S.", rating: 5, comment: "Loved the ambience and the chicken burger was so juicy. Will visit again.", date: "2026-06-05" },
  { id: "rev-3", name: "Vignesh R.", rating: 4, comment: "Great taste and quick service. The brownie is a must try!", date: "2026-05-28" },
  { id: "rev-4", name: "Divya M.", rating: 5, comment: "Best filter coffee in Sattur, hands down. Feels like home.", date: "2026-05-20" },
  { id: "rev-5", name: "Karthik B.", rating: 4, comment: "Good portions, fresh ingredients and friendly staff.", date: "2026-05-10" },
];

export const itemReviews = {
  "item-white-sauce-pasta": [
    { id: "irev-1", item_id: "item-white-sauce-pasta", name: "Meena T.", rating: 5, comment: "So creamy and flavorful, my favorite pasta in town.", date: "2026-06-01" },
  ],
  "item-chicken-burger": [
    { id: "irev-2", item_id: "item-chicken-burger", name: "Suresh P.", rating: 5, comment: "Perfectly grilled and juicy, loved it!", date: "2026-05-22" },
  ],
};
...
export const offers = [
  {
    ...
    status: "active",
    products: [
      { id: "item-chicken-burger", name: "Chicken Burger", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=500&q=80", quantity: 1, variantId: "var-cb-reg", variantName: "Regular", price: 150 },
      { id: "item-oreo-shake", name: "Oreo Shake", image: "https://images.unsplash.com/photo-1541658016709-82535e94bc69?w=500&q=80", quantity: 1, variantId: "var-os-reg", variantName: "Regular", price: 110 },
    ],
    get originalTotal() {
  ...
  },
  {
    ...
    status: "active",
    products: [
      { id: "item-white-sauce-pasta", name: "White Sauce Pasta", image: "https://images.unsplash.com/photo-1645112411341-6c4fd023714a?w=500&q=80", quantity: 1, variantId: "var-wsp-reg", variantName: "Regular", price: 180 },
      { id: "item-filter-coffee", name: "South Indian Filter Coffee", image: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=500&q=80", quantity: 1, variantId: "var-fc-reg", variantName: "Regular", price: 40 },
    ],
    get originalTotal() {
      return this.products.reduce((s, p) => s + p.price * p.quantity, 0);
    },
