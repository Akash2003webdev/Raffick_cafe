...
export default function MenuPage({ onSelectCategory }) {
  useSEO({
    title: "Menu | Raffick Cafe - Veg & Non-Veg Dishes",
    description:
      "Explore the full menu at Raffick Cafe, Sattur. Coffee, burgers, pasta & desserts across all categories, freshly prepared daily. Order takeaway or delivery.",
    path: "/menu",
  });
